...
TextTheme _buildTextTheme(TextTheme base) {
  return base
      .copyWith(
        headline1: base.display4.copyWith(
          fontFamily: 'Eczar',
          fontWeight: FontWeight.w600,
        ),
        headline2: base.display3.copyWith(
          fontFamily: 'Libre Franklin',
          fontWeight: FontWeight.w300,
        ),
        headline3: base.display2.copyWith(
          fontFamily: 'Libre Franklin',
          fontWeight: FontWeight.w500,
        ),
        headline4: base.display1.copyWith(
          fontFamily: 'Eczar',
          fontWeight: FontWeight.w600,
        ),
        ...
        subtitle2: base.subtitle.copyWith(
          fontFamily: 'Libre Franklin',
          fontWeight: FontWeight.w500,
        ),
        bodyText2: base.body1.copyWith(
          fontFamily: 'Libre Franklin',
          fontWeight: FontWeight.w400,
          fontSize: 14.0,
        ),
        bodyText1: base.body2.copyWith(
          fontFamily: 'Eczar',
          fontWeight: FontWeight.w400,
          fontSize: 16.0,
        ),
